...
CREATE TABLE IF NOT EXISTS sites (
    ...
    start_date DATE, -- Added for explicit start
    end_date DATE, -- Added for "Rhythm" calculation
    created_at TIMESTAMP WITH TIME ZONE DEFAULT timezone('utc'::text, now()) NOT NULL
);
...
CREATE TABLE IF NOT EXISTS logs (
    id BIGINT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
    action TEXT,
    user_id TEXT, -- Changed to TEXT to support 'rescue-admin' and UUIDs
    details TEXT,
...
CREATE TABLE IF NOT EXISTS time_sessions (
    ...
    task_id TEXT, -- Changed from BIGINT REFERENCES to TEXT to support Site-Specific JSON tasks
